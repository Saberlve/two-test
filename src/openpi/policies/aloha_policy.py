...
class AlohaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # models (e.g. RMT recurrent memory) then receive episode_pos/episode_id/stream_id =
        # None and fall back to per-step defaults, which resets the memory/history cache every
        # step and leaves the model with no temporal context. Mirrors RepackTransform's pass-through.
