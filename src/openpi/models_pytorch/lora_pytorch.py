...
class LoRATrainingConfig:
    ...
    # Extra non-LoRA module names to train in addition to `trainable_modules`.
...
def freeze_for_lora_training(
    ...
    if lora_config.train_non_lora_layers:
        trainable_modules = set(lora_config.trainable_modules) | set(lora_config.extra_trainable_modules)
